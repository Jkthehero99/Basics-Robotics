...
d7 = 0;
N = 20000;
t1 = alpha1_min + (alpha1_max - alpha1_min)*rand(N,1);
t2_0 = alpha2_0_min + (alpha2_0_max - alpha2_0_min)*rand(N,1);
t2_1 = alpha2_1_min + (alpha2_1_max - alpha2_1_min)*rand(N,1);
t2_2 = alpha2_2_min + (alpha2_2_max - alpha2_2_min)*rand(N,1);
t2_3 = alpha2_3_min + (alpha2_3_max - alpha2_3_min)*rand(N,1);
t2_4 = alpha2_4_min + (alpha2_4_max - alpha2_4_min)*rand(N,1);
t2_5 = alpha2_5_min + (alpha2_5_max - alpha2_5_min)*rand(N,1);
t3_0 = alpha3_0_min + (alpha3_0_max - alpha3_0_min)*rand(N,1);
t3_1 = alpha3_1_min + (alpha3_1_max - alpha3_1_min)*rand(N,1);
t4 = alpha4_min + (alpha4_max - alpha4_min)*rand(N,1);
t5 = alpha5_min + (alpha5_max - alpha5_min)*rand(N,1);
t6 = alpha6_min + (alpha6_max - alpha6_min)*rand(N,1);
t7 = alpha7_min + (alpha7_max - alpha7_min)*rand(N,1);

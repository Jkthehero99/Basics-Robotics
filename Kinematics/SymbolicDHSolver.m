...
if ch1 == 1
    ...
    %elements = {0, -pi/2:0.5:11*pi/18, -23*pi/18:0.5:5*pi/18, -20*pi/18:0.5:20*pi/18, -12*pi/18:0.5:12*pi/18, -40*pi/18:0.5:40*pi/18}; %cell array with N vectors to combine
    ...
    for j=1:size(result,1)
        f(j,:)=Tpost(result(j,1),result(j,2),result(j,3),result(j,4),result(j,5));
    end
